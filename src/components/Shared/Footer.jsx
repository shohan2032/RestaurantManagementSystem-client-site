...
import RestaurantLogo from "../../assets/AdminPanelImage/RestaurantLogo/logo1.jpg";
const Footer = () => {
    return (
        <footer className="footer p-10 text-neutral-content bg-gray-950 rounded-t-lg rounded-b-lg">
            <div>
                <Link to={'/'}>
                    <img className="w-12 rounded-t-lg rounded-b-lg" src={RestaurantLogo} alt=""/>
                    <p>M.S. Restaurant Ltd.<br/>Providing reliable foods since 2000</p>
                </Link>
            </div> 
            <div>
            ...
            <div>
                <p>Copyright © 2023 - All right reserved by M.S. Restaurant Ltd.</p>
            </div>
        </footer>
    );
};
